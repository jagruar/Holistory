...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Holistory.Domain.Aggregates.TopicAggregate.Attempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Holistory.Domain.Aggregates.TopicAggregate.Question", b =>
                {
                    ...
                    b.OwnsMany("Holistory.Domain.Aggregates.TopicAggregate.Answer", "Answers", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                            ...
                            b1.HasOne("Holistory.Domain.Aggregates.TopicAggregate.Question")
                                .WithMany("Answers")
